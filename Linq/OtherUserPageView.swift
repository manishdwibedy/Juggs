...
class OtherUserPageView: UIPageViewController, UIPageViewControllerDelegate, UIPageViewControllerDataSource {
    
    lazy var bioAndMyJuggs: [UIViewController] = {
        
        return [self.ViewControllerInstance(name: "OtherUserBio"),
