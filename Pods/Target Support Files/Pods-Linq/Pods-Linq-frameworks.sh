...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/InstagramSimpleOAuth/InstagramSimpleOAuth.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SimpleOAuth2/SimpleOAuth2.framework"
